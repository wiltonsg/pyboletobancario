...
class TicketTestCase(unittest.TestCase):
    ...
    def test_get_url(self):
        self.assertEqual(self.ticket._get_url(param1='value1'),
                         'https://www.boletobancario.com/boletofacil/integration/api/v1/?token=12345&param1=value1&')

    def test_get_url_two_params(self):
        self.assertEqual(self.ticket._get_url(param1='value1', param2='value2'),
                         'https://www.boletobancario.com/boletofacil/integration/api/v1/?token=12345&param1=value1&param2=value2&')

    def test_get_url_three_params(self):
        self.assertEqual(self.ticket._get_url(param1='value1', param2='value2', param3='value3'),
                         'https://www.boletobancario.com/boletofacil/integration/api/v1/?token=12345&param1=value1&param2=value2&param3=value3&')
